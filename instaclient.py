...
class InstaClient:
    ...
    def _get_user_id(self, username: str) -> str:
        ...
        user_data_raw = requests.get(uri, headers=self.token, cookies=self.sessionid).text
    ...
    def _get_posts_id(self, username: str) -> list:
        ...
        posts_data_raw = requests.get(uri, headers=self.token, cookies=self.sessionid).text
